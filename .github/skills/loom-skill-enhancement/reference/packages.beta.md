...
- For this offline snapshot, the current latest beta version is `0.2.96-beta`.
...
- Good: restore all three packages at `0.2.96-beta`.
- Bad: restore one package at `0.2.96-beta` and another at a different prerelease.
...
```powershell
dotnet add package Techne.Loom.Abstractions --version 0.2.96-beta
dotnet add package Techne.Loom.Common --version 0.2.96-beta
dotnet add package Techne.Loom.SkillOrchestrator --version 0.2.96-beta
```
...
- `resolved_runtime_version: 0.2.96-beta`
