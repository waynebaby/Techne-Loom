...
- Channel: `beta`
- Current latest beta SO bundle version for this offline snapshot: `0.2.121-beta`
...
2. Restore the full SO runtime bundle at `0.2.121-beta`.
...
- For `/loom-skill-enhancement` itself and any SO-enhanced target skill, official workflow operations must use the published beta-channel SO package artifacts. Do not treat repository source builds or ad hoc local binaries as the normal workflow-operation surface.
