...
- For this offline snapshot, the current latest beta version is `0.2.118-beta`.
...
- Good: restore all three packages at `0.2.118-beta`.
...
```powershell
dotnet add package Techne.Loom.Abstractions --version 0.2.118-beta
dotnet add package Techne.Loom.Common --version 0.2.118-beta
dotnet add package Techne.Loom.AgentOrchestrator --version 0.2.118-beta
```
...
- `resolved_runtime_version: 0.2.118-beta`
