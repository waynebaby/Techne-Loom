...
This offline snapshot is bound to beta `0.3.320-beta`. The active NuGet release closure is exactly sixteen self-contained runtime packages: eight AO and eight SO product+RID packages. Core libraries are source projects, not active runtime packages.
