...
- For this offline snapshot, the current latest released version is `0.3.254`.
...
```powershell
dotnet add package Techne.Loom.Abstractions --version 0.3.254
dotnet add package Techne.Loom.Common --version 0.3.254
dotnet add package Techne.Loom.AgentOrchestrator --version 0.3.254
```
...
- `resolved_runtime_version: 0.3.254`
