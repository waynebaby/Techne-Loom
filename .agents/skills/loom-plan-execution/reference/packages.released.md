...
- For this offline snapshot, the current latest released version is `0.2.216`.
...
- Good: restore all three packages at `0.2.216`.
...
```powershell
dotnet add package Techne.Loom.Abstractions --version 0.2.216
dotnet add package Techne.Loom.Common --version 0.2.216
dotnet add package Techne.Loom.AgentOrchestrator --version 0.2.216
```
...
- `resolved_runtime_version: 0.2.216`
