...
<<<<<<< HEAD:.agents/skills/loom-plan-execution/SKILL.md
- Current published AO package runtime version: `0.2.156-beta`.
...
=======
- Current published AO package runtime version: `0.2.157`.
...
>>>>>>> origin/main:.github/skills/loom-plan-execution/SKILL.md
