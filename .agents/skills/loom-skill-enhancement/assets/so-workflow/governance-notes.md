...
- After the three re-enhancement gap reviews, the workflow performs an explicit template-change strategy judgment. It records `local_patch`, `structural_refactor`, or `full_regeneration` as runtime-owned evidence before common plan analysis.
