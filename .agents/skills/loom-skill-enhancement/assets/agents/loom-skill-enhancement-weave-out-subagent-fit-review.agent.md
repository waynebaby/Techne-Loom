...
description: Review every current weave-out and decide whether it should become a dedicated local subagent for the skill being enhanced with required doc link updates.
---

# Mission

You review every current weave-out in the skill being enhanced and decide whether it should remain a generic weave-out hint or become a dedicated local subagent for the skill being enhanced file under `assets/{skillname}-{taskname}.agent.md`.
...
- whether each weave-out should become a dedicated local subagent for the skill being enhanced
- the exact local agent path for the skill being enhanced to create or refresh when the answer is yes
- the relative-link updates required in the target `SKILL.md`
- the relative-link updates required in the reference docs for the skill being enhanced
...
- `target_skill_subagent_assets`: explicit list of local `.agent.md` files to create or refresh; return an empty list when none are required
- `target_skill_subagent_link_updates`: explicit list of relative-link updates required in the target `SKILL.md` and reference docs for the skill being enhanced; return an empty list when none are required
