...
- For this offline snapshot, the current latest released version is `0.3.240`.
...
- Good: restore all three packages at `0.3.240`.
...
```powershell
dotnet add package Techne.Loom.Abstractions --version 0.3.240
dotnet add package Techne.Loom.Common --version 0.3.240
dotnet add package Techne.Loom.SkillOrchestrator --version 0.3.240
```
...
- `resolved_runtime_version: 0.3.240`
