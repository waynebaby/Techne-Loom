...
- For this offline snapshot, the current latest released version is `0.2.211`.
...
- Good: restore all three packages at `0.2.211`.
...
```powershell
dotnet add package Techne.Loom.Abstractions --version 0.2.211
dotnet add package Techne.Loom.Common --version 0.2.211
dotnet add package Techne.Loom.SkillOrchestrator --version 0.2.211
```
...
- `resolved_runtime_version: 0.2.211`
