...
- For this offline snapshot, the current latest beta version is `0.3.242-beta`.
...
```powershell
dotnet add package Techne.Loom.SkillOrchestrator --version 0.3.242-beta
dotnet add package Techne.Loom.Common --version 0.3.242-beta
dotnet add package Techne.Loom.Abstractions --version 0.3.242-beta
```
...
- `resolved_runtime_version: 0.3.242-beta`
