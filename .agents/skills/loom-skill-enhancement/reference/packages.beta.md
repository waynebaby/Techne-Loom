...
- Good .NET CLI path: restore the three IL packages above at `0.3.234-beta`, validate the host/CLI preflight, then use one unified runtime directory.
...
```powershell
dotnet add package Techne.Loom.SkillOrchestrator --version 0.3.249-beta
