...
- Released package index reference: `assets/so-workflow/reference/so/packages.released.md`
- Beta package index reference: `assets/so-workflow/reference/so/packages.beta.md`
- Target-local SO contract reference: `assets/so-workflow/reference/so/runtime-contracts.md`
- Target-local SO governance reference: `assets/so-workflow/reference/so/runtime-governance.md`
- Weave-out subagents:
