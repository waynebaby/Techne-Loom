...
| `transition.capture_runtime_exception_workaround` | blocked strongest-earned evidence for the failed published bundle preflight plus the explicitly approved repo-src workaround and its fresh guide export |
...
| `transition.collect_material_review` | user-owned structured material selection plus mandatory freeform comments |
| `transition.update_research_seed` | runtime-owned continuation payload carrying material-review or draft-review feedback into the next bounded research pass |
