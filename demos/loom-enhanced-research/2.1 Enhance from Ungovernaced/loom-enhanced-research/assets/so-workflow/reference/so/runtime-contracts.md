...
This target-local excerpt records the SO contract facts used by this historical demo. It does not replace the runtime guide captured by the historical enhancement pass.
