...
```text
https://www.nuget.org/api/v2/package/Techne.Loom.AgentOrchestrator/0.2.216-beta
https://www.nuget.org/api/v2/package/Techne.Loom.SkillOrchestrator/0.2.216-beta
```

## Version Shape

<!-- package-version-block:start -->
- The current latest published beta package version is `0.2.216-beta`.
...
| --- | --- | --- | --- | --- |
| Abstractions | `Techne.Loom.Abstractions` | `dotnet add package Techne.Loom.Abstractions --version 0.2.216-beta` | [latest .nupkg](https://github.com/waynebaby/Techne-Loom/releases/download/nuget-beta-latest/Techne.Loom.Abstractions.latest.nupkg) | consume exact latest prerelease |
| Common | `Techne.Loom.Common` | `dotnet add package Techne.Loom.Common --version 0.2.216-beta` | [latest .nupkg](https://github.com/waynebaby/Techne-Loom/releases/download/nuget-beta-latest/Techne.Loom.Common.latest.nupkg) | consume exact latest prerelease |
| Plan execution runtime | `Techne.Loom.AgentOrchestrator` | `dotnet add package Techne.Loom.AgentOrchestrator --version 0.2.216-beta` plus restore `Techne.Loom.Common` and `Techne.Loom.Abstractions` at `0.2.216-beta` | [latest .nupkg](https://github.com/waynebaby/Techne-Loom/releases/download/nuget-beta-latest/Techne.Loom.AgentOrchestrator.latest.nupkg) | use exact latest prerelease AO runtime bundle |
| Skill execution runtime | `Techne.Loom.SkillOrchestrator` | `dotnet add package Techne.Loom.SkillOrchestrator --version 0.2.216-beta` plus restore `Techne.Loom.Common` and `Techne.Loom.Abstractions` at `0.2.216-beta` | [latest .nupkg](https://github.com/waynebaby/Techne-Loom/releases/download/nuget-beta-latest/Techne.Loom.SkillOrchestrator.latest.nupkg) | use exact latest prerelease SO runtime bundle |
