...
Installers and archives must publish SHA-256 checksums. Release automation must keep the runtime version, CLI contract version, and embedded guide bundle aligned.
