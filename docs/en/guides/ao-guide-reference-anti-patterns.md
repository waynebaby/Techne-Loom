...
[Hub](ao-guide.md) | [Flow](ao-guide-flow.md) | [Index](ao-guide-reference.md) | [Root](../README.md) | [Chinese](../../zh-cn/guides/ao-guide-reference-anti-patterns.md)
...
- Letting a skill under Loom Skill Orchestrator governance ask users to choose package/channel when the runtime version is already bound by the CI/CD-managed skill package version block or checked-in runtime lock.
