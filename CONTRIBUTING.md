...
- Use `Loom Agent Plan-Execution Orchestrator` as the user-facing AO product name in public docs, while preserving package IDs, CLI names, and source identities.
